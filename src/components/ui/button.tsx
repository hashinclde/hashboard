  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-medium hover:shadow-strong",
        success: "bg-success text-white hover:bg-success/90 shadow-soft hover:shadow-medium",
        warning: "bg-warning text-foreground hover:bg-warning/90 shadow-soft hover:shadow-medium",
        glass: "glass text-foreground hover:bg-card/90",
        agent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft hover:shadow-medium border border-accent/20",
      },
      size: {
